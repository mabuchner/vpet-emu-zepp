...
function _interrupt(vector) {
  _RAM[(_SP - 1) & 0xff] = (_PC >> 8) & 0xf;
  _RAM[(_SP - 2) & 0xff] = (_PC >> 4) & 0xf;
  _SP = (_SP - 3) & 0xff;
  _RAM[_SP] = _PC & 0xf;
  _IF = 0;
  _HALT = 0;
  ...
  switch (opcode >> 8) {
    ...
    case 0x1: {
      ...
      _PC = _NPC =
        ...
        _RAM[_SP];
      _SP = (_SP + 3) & 0xff;
      _IX < RAM_SIZE ? (_RAM[_IX] = opcode & 0xf) : set_mem(_IX, opcode & 0xf);
      set_mem((_IX & 0xf00) | ((_IX + 1) & 0xff), (opcode >> 4) & 0xf);
    ...
    case 0x4: {
      ...
      _RAM[(_SP - 1) & 0xff] = ((_PC + 1) >> 8) & 0xf;
      _RAM[(_SP - 2) & 0xff] = ((_PC + 1) >> 4) & 0xf;
      _SP = (_SP - 3) & 0xff;
      _RAM[_SP] = (_PC + 1) & 0xf;
      _PC = (_NPC & 0x1f00) | (opcode & 0x0ff);
      exec_cycles = 7;
      ...
      switch ((opcode >> 4) & 0xf) {
        ...
        case 0x8: {
          ...
          if (r === 0) {
            ...
            _IX < RAM_SIZE ? (_RAM[_IX] = res & 0xf) : set_mem(_IX, res & 0xf);
          } else {
            _IY < RAM_SIZE ? (_RAM[_IY] = res & 0xf) : set_mem(_IY, res & 0xf);
          }
          _PC = _NPC = (_PC & 0x1000) | ((_PC + 1) & 0xfff);
          exec_cycles = 7;
          break;
      ...
      switch ((opcode >> 6) & 0x3) {
        case 0x0: {
          ...
          if (r === 0) {
            ...
            _IX < RAM_SIZE
              ? (_RAM[_IX] = opcode & 0xf)
              : set_mem(_IX, opcode & 0xf);
          } else {
            _IY < RAM_SIZE
              ? (_RAM[_IY] = opcode & 0xf)
              : set_mem(_IY, opcode & 0xf);
          }
          _PC = _NPC = (_PC & 0x1000) | ((_PC + 1) & 0xfff);
          break;
        }
          ...
          switch ((opcode >> 2) & 0xf) {
            ...
            case 0x9: {
              ...
              if (r === 0) {
                ...
                _IX < RAM_SIZE
                  ? (_RAM[_IX] = (_IX >> 4) & 0xf)
                  : set_mem(_IX, (_IX >> 4) & 0xf);
              } else {
                _IY < RAM_SIZE
                  ? (_RAM[_IY] = (_IX >> 4) & 0xf)
                  : set_mem(_IY, (_IX >> 4) & 0xf);
              }
              _PC = _NPC = (_PC & 0x1000) | ((_PC + 1) & 0xfff);
              break;
            }
            ...
            case 0xd: {
              ...
              if (r === 0) {
                ...
                _IX < RAM_SIZE
                  ? (_RAM[_IX] = (_IY >> 4) & 0xf)
                  : set_mem(_IX, (_IY >> 4) & 0xf);
              } else {
                _IY < RAM_SIZE
                  ? (_RAM[_IY] = (_IY >> 4) & 0xf)
                  : set_mem(_IY, (_IY >> 4) & 0xf);
              }
              _PC = _NPC = (_PC & 0x1000) | ((_PC + 1) & 0xfff);
              break;
            }
        ...
        case 0xc: {
          switch (opcode & 0xf) {
            ...
            case 0xa: {
              ...
              // SP←SP-1, M(SP)←F
              _SP = (_SP - 1) & 0xff;
              _RAM[_SP] = ((_IF << 3) | (_DF << 2) | (_ZF << 1) | _CF) & 0xf;
              _PC = _NPC = (_PC & 0x1000) | ((_PC + 1) & 0xfff);
              break;
            }
            case 0xb: {
